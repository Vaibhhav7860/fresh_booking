        ...
        <div className={styles.grid}>
          ...
          <div className={styles.brand}>
            ...
            <div className={styles.socials}>
              <a href="https://www.facebook.com/FreshBooking.Gurgaon" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className={styles.socialIcon}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"/></svg>
              </a>
              <a href="https://x.com/FreshBookingGwn" target="_blank" rel="noopener noreferrer" aria-label="Twitter" className={styles.socialIcon}>
              ...
              <a href="https://www.instagram.com/freshbooking_gurgaon/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className={styles.socialIcon}>
              ...
              <a href="https://www.linkedin.com/company/freshbooking-gurgaon" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className={styles.socialIcon}>
              ...
              <a href="https://www.youtube.com/@FreshBooking_Gurgaon" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className={styles.socialIcon}>
