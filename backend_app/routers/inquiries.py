...
from backend_app.database import inquiries_collection, properties_collection, users_collection
from backend_app.models.inquiry import InquiryCreate, InquiryResponse
