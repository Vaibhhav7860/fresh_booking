...
from backend_app.database import properties_collection, users_collection
from backend_app.models.property import PropertyCreate, PropertyUpdate, PropertyResponse
